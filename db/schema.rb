...
ActiveRecord::Schema.define(version: 20171119163003) do
  ...
  create_table "examples", force: :cascade do |t|
    ...
    t.index ["sense_id"], name: "index_examples_on_sense_id"
  end
  ...
  add_foreign_key "examples", "senses"
  add_foreign_key "senses", "lexemes"
end
